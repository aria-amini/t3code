...
const remoteDebuggingPort =
	process.env.T3CODE_DESKTOP_REMOTE_DEBUGGING_PORT?.trim();
...
function killChildTreeByPid(pid, signal) {
	...
	NodeChildProcess.spawnSync("pkill", [`-${signal}`, "-P", String(pid)], {
		stdio: "ignore",
	});
}
