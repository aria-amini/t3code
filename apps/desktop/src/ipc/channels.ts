...
export const GET_WINDOW_FULLSCREEN_STATE_CHANNEL =
	"desktop:get-window-fullscreen-state";
export const WINDOW_FULLSCREEN_STATE_CHANNEL =
	"desktop:window-fullscreen-state";
export const DESKTOP_APP_ACTIVATION_READY_CHANNEL =
	"desktop:app-activation-ready";
export const DESKTOP_APP_ACTIVATION_COMPLETE_CHANNEL =
	"desktop:app-activation-complete";
export const DESKTOP_APP_ACTIVATION_REQUEST_CHANNEL =
	"desktop:app-activation-request";
...
export const PREVIEW_SNAP_SHOT_CONFIG_CHANNEL =
	"desktop:preview-snap-shot-config";
export const APPLY_SNAP_SHOT_CONFIG_CHANNEL = "desktop:apply-snap-shot-config";
export const REQUEST_SNAP_SHOT_PERMISSIONS_CHANNEL =
	"desktop:request-snap-shot-permissions";
export const GET_SNAP_SHOT_STATE_CHANNEL = "desktop:get-snap-shot-state";
export const CHECK_SNAP_SHOT_SHORTCUT_CHANNEL =
	"desktop:check-snap-shot-shortcut";
export const SET_SNAP_SHOT_SHORTCUT_SUPPRESSED_CHANNEL =
	"desktop:set-snap-shot-shortcut-suppressed";
export const LIST_PENDING_SNAP_SHOTS_CHANNEL =
	"desktop:list-pending-snap-shots";
...
export const DISMISS_SNAP_SHOT_ANIMATION_CHANNEL =
	"desktop:dismiss-snap-shot-animation";
...
export const CLEAR_CONNECTION_CATALOG_CHANNEL =
	"desktop:clear-connection-catalog";
...
export const DISCONNECT_SSH_ENVIRONMENT_CHANNEL =
	"desktop:disconnect-ssh-environment";
export const FETCH_SSH_ENVIRONMENT_DESCRIPTOR_CHANNEL =
	"desktop:fetch-ssh-environment-descriptor";
export const BOOTSTRAP_SSH_BEARER_SESSION_CHANNEL =
	"desktop:bootstrap-ssh-bearer-session";
export const FETCH_SSH_SESSION_STATE_CHANNEL =
	"desktop:fetch-ssh-session-state";
export const ISSUE_SSH_WEBSOCKET_TOKEN_CHANNEL =
	"desktop:issue-ssh-websocket-token";
export const SSH_PASSWORD_PROMPT_CHANNEL = "desktop:ssh-password-prompt";
export const RESOLVE_SSH_PASSWORD_PROMPT_CHANNEL =
	"desktop:resolve-ssh-password-prompt";
export const GET_SERVER_EXPOSURE_STATE_CHANNEL =
	"desktop:get-server-exposure-state";
export const SET_SERVER_EXPOSURE_MODE_CHANNEL =
	"desktop:set-server-exposure-mode";
export const SET_TAILSCALE_SERVE_ENABLED_CHANNEL =
	"desktop:set-tailscale-serve-enabled";
export const GET_ADVERTISED_ENDPOINTS_CHANNEL =
	"desktop:get-advertised-endpoints";
export const GET_WSL_STATE_CHANNEL = "desktop:get-wsl-state";
export const SET_WSL_BACKEND_ENABLED_CHANNEL =
	"desktop:set-wsl-backend-enabled";
export const SET_WSL_DISTRO_CHANNEL = "desktop:set-wsl-distro";
export const SET_WSL_ONLY_CHANNEL = "desktop:set-wsl-only";
export const SSH_PASSWORD_PROMPT_CANCELLED_RESULT =
...
export const PREVIEW_REGISTER_WEBVIEW_CHANNEL =
	"desktop:preview-register-webview";
...
export const PREVIEW_SET_COLOR_SCHEME_CHANNEL =
	"desktop:preview-set-color-scheme";
export const PREVIEW_SET_AUDIO_MUTED_CHANNEL =
	"desktop:preview-set-audio-muted";
...
export const PREVIEW_SET_ANNOTATION_THEME_CHANNEL =
	"desktop:preview-set-annotation-theme";
export const PREVIEW_PICK_ELEMENT_CHANNEL = "desktop:preview-pick-element";
export const PREVIEW_CANCEL_PICK_ELEMENT_CHANNEL =
	"desktop:preview-cancel-pick-element";
export const PREVIEW_CAPTURE_SCREENSHOT_CHANNEL =
	"desktop:preview-capture-screenshot";
export const PREVIEW_REVEAL_ARTIFACT_CHANNEL =
	"desktop:preview-reveal-artifact";
export const PREVIEW_COPY_ARTIFACT_CHANNEL = "desktop:preview-copy-artifact";
export const PREVIEW_PICTURE_IN_PICTURE_OPEN_CHANNEL =
	"desktop:preview-pip-open";
export const PREVIEW_PICTURE_IN_PICTURE_CLOSE_CHANNEL =
	"desktop:preview-pip-close";
export const PREVIEW_PICTURE_IN_PICTURE_FRAME_CHANNEL =
	"desktop:preview-pip-frame";
export const PREVIEW_AUTOMATION_STATUS_CHANNEL =
	"desktop:preview-automation-status";
export const PREVIEW_AUTOMATION_SNAPSHOT_CHANNEL =
	"desktop:preview-automation-snapshot";
export const PREVIEW_AUTOMATION_CLICK_CHANNEL =
	"desktop:preview-automation-click";
export const PREVIEW_AUTOMATION_TYPE_CHANNEL =
	"desktop:preview-automation-type";
export const PREVIEW_AUTOMATION_PRESS_CHANNEL =
	"desktop:preview-automation-press";
export const PREVIEW_AUTOMATION_SCROLL_CHANNEL =
	"desktop:preview-automation-scroll";
export const PREVIEW_AUTOMATION_EVALUATE_CHANNEL =
	"desktop:preview-automation-evaluate";
export const PREVIEW_AUTOMATION_WAIT_FOR_CHANNEL =
	"desktop:preview-automation-wait-for";
export const PREVIEW_RECORDING_START_CHANNEL =
	"desktop:preview-recording-start";
...
export const PREVIEW_RECORDING_FRAME_CHANNEL =
	"desktop:preview-recording-frame";
