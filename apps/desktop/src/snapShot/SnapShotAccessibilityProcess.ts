...
type AccessibilityMessage =
	...
	| {
			...
			readonly context?: CapturedWindowAccessibilityContext;
	  };

const completedRead = (
	context?: CapturedWindowAccessibilityContext,
): AccessibilityRead => ({
...
export function startSnapShotAccessibilityProcess(
	workerPath: string,
	...
	let resultResolve:
		| ((value: CapturedWindowAccessibilityContext | undefined) => void)
		| undefined;
...
export function makeSnapShotAccessibilityProcessPool(
	workerPath: string,
