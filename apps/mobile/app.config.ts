...
const personalTeamBundleIdentifier =
	repoEnv.T3CODE_IOS_PERSONAL_TEAM_BUNDLE_ID?.trim();
...
const PREVIEW_ASSETS = {
	...
	androidAdaptiveBackgroundImage:
		"./assets/android-icon-background-nightly.png",
...
const config: ExpoConfig = {
	...
	ios: {
		...
		infoPlist: {
			...
			NSPhotoLibraryAddUsageDescription:
				"Allow T3 Code to save images to your photo library.",
	...
	plugins: [
		...
		[
			"expo-audio",
			{
				microphonePermission:
					"Allow T3 Code to use your microphone for voice input.",
		...
		[
			"expo-image-picker",
			{ photosPermission: false, microphonePermission: false },
		],
		[
			"expo-splash-screen",
			{
