...
const escapedWorkspaceRoot = workspaceRoot.replace(
	/[.*+?^${}()|[\]\\]/g,
	"\\$&",
);
const mobileShikiRoot = path.dirname(
	require.resolve("shiki/package.json", { paths: [__dirname] }),
);
...
config.resolver = {
	...
	extraNodeModules: {
		...
		"@shikijs/engine-javascript": resolveShikiDependencyRoot(
			"@shikijs/engine-javascript",
		),
		"@shikijs/engine-oniguruma": resolveShikiDependencyRoot(
		...
		"@shikijs/vscode-textmate": resolveShikiDependencyRoot(
