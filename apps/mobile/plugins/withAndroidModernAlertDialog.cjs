		...
		resources.style.push(
			{
				...
				item: [
					{
						_: "@drawable/alert_dialog_background",
					...
					{
						_: "@style/AppAlertDialog.Title",
						$: { name: "android:windowTitleStyle" },
					},
					{
						_: "@style/AppAlertDialog.Button",
						$: { name: "buttonBarPositiveButtonStyle" },
					},
					{
						_: "@style/AppAlertDialog.Button",
						$: { name: "buttonBarNegativeButtonStyle" },
					},
					{
						_: "@style/AppAlertDialog.Button",
						$: { name: "buttonBarNeutralButtonStyle" },
					},
				],
			},
			{
				$: {
					name: "AppAlertDialog.Title",
			...
			},
			{
				...
				item: [
					...
					{ _: "@font/dm_sans_500medium", $: { name: "android:fontFamily" } },
					{
						_: "@color/alert_dialog_button_text",
...
module.exports = function withAndroidModernAlertDialog(config) {
	return withAlertDialogBackgroundDrawable(
		withAlertDialogColors(withAlertDialogStyles(config)),
	);
};
