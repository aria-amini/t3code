...
const GENERATED_CSS_PATH = NodePath.resolve(
	import.meta.dirname,
	"../generated-uniwind-themes.css",
);
...
const color = (
	...
	if (value === undefined) {
		throw new Error(
			`Unknown Tailwind color ${family}${shade === undefined ? "" : `-${shade}`}.`,
		);
	}
...
const ADAPTIVE_COLORS = {
	"--color-adaptive-amber-50-950-a40": [
		color("amber", 50),
		color("amber", 950, 0.4),
	],
	"--color-adaptive-amber-200-900-a60": [
		color("amber", 200),
		color("amber", 900, 0.6),
	],
	"--color-adaptive-amber-500-a12-a16": [
		color("amber", 500, 0.12),
		color("amber", 500, 0.16),
	],
	...
	"--color-adaptive-blue-50-blue-400-a14": [
		color("blue", 50),
		color("blue", 400, 0.14),
	],
	"--color-adaptive-blue-300-a50-blue-400-a28": [
		color("blue", 300, 0.5),
		color("blue", 400, 0.28),
	],
	"--color-adaptive-blue-500-a20-blue-400-a15": [
		color("blue", 500, 0.2),
		color("blue", 400, 0.15),
	],
	...
	"--color-adaptive-emerald-600-400": [
		color("emerald", 600),
		color("emerald", 400),
	],
	"--color-adaptive-emerald-700-300": [
		color("emerald", 700),
		color("emerald", 300),
	],
	"--color-adaptive-indigo-500-a12-a16": [
		color("indigo", 500, 0.12),
		color("indigo", 500, 0.16),
	],
	"--color-adaptive-indigo-600-300": [
		color("indigo", 600),
		color("indigo", 300),
	],
	"--color-adaptive-indigo-700-300": [
		color("indigo", 700),
		color("indigo", 300),
	],
	"--color-adaptive-neutral-100-900": [
		color("neutral", 100),
		color("neutral", 900),
	],
	"--color-adaptive-neutral-200-700-a60": [
		color("neutral", 200),
		color("neutral", 700, 0.6),
	],
	"--color-adaptive-neutral-200-800": [
		color("neutral", 200),
		color("neutral", 800),
	],
	...
	"--color-adaptive-neutral-200-white-a6": [
		color("neutral", 200),
		color("white", undefined, 0.06),
	],
	"--color-adaptive-neutral-200-white-a8": [
		color("neutral", 200),
		color("white", undefined, 0.08),
	],
	...
	"--color-adaptive-neutral-400-500": [
		color("neutral", 400),
		color("neutral", 500),
	],
	...
	"--color-adaptive-neutral-500-a10-a16": [
		color("neutral", 500, 0.1),
		color("neutral", 500, 0.16),
	],
	"--color-adaptive-neutral-500-400": [
		color("neutral", 500),
		color("neutral", 400),
	],
	"--color-adaptive-neutral-500-500": [
		color("neutral", 500),
		color("neutral", 500),
	],
	"--color-adaptive-neutral-600-300": [
		color("neutral", 600),
		color("neutral", 300),
	],
	"--color-adaptive-neutral-600-400": [
		color("neutral", 600),
		color("neutral", 400),
	],
	"--color-adaptive-neutral-950-50": [
		color("neutral", 950),
		color("neutral", 50),
	],
	"--color-adaptive-red-50-950-a80": [color("red", 50), color("red", 950, 0.8)],
	"--color-adaptive-red-200-800": [color("red", 200), color("red", 800)],
	"--color-adaptive-red-600-a80-400-a80": [
		color("red", 600, 0.8),
		color("red", 400, 0.8),
	],
	"--color-adaptive-red-700-300": [color("red", 700), color("red", 300)],
	"--color-adaptive-rose-100-500-a18": [
		color("rose", 100),
		color("rose", 500, 0.18),
	],
	"--color-adaptive-rose-100-a80-500-a12": [
		color("rose", 100, 0.8),
		color("rose", 500, 0.12),
	],
	"--color-adaptive-rose-300-a70-400-a28": [
		color("rose", 300, 0.7),
		color("rose", 400, 0.28),
	],
	"--color-adaptive-rose-500-a12-a16": [
		color("rose", 500, 0.12),
		color("rose", 500, 0.16),
	],
	...
	"--color-adaptive-sky-500-a12-a16": [
		color("sky", 500, 0.12),
		color("sky", 500, 0.16),
	],
	"--color-adaptive-sky-600-400": [color("sky", 600), color("sky", 400)],
	"--color-adaptive-sky-700-300": [color("sky", 700), color("sky", 300)],
	"--color-adaptive-violet-500-a12-a16": [
		color("violet", 500, 0.12),
		color("violet", 500, 0.16),
	],
	"--color-adaptive-violet-600-400": [
		color("violet", 600),
		color("violet", 400),
	],
	"--color-adaptive-violet-700-300": [
		color("violet", 700),
		color("violet", 300),
	],
	"--color-adaptive-white-neutral-950-a70": [
		color("white"),
		color("neutral", 950, 0.7),
	],
	"--color-adaptive-zinc-500-a12-a16": [
		color("zinc", 500, 0.12),
		color("zinc", 500, 0.16),
	],
	...
	const variants = [
		...
		...BUILT_IN_THEME_IDS.flatMap((themeId) =>
			APPEARANCES.map((appearance) =>
				renderVariant(
					`${themeId}-${appearance}`,
					variablesFor(themeId, appearance),
				),
			),
		),
	];
...
const readVariantBody = (
	...
	if (markerIndex === -1)
		throw new Error(`Could not find ${marker} in global.css.`);
		...
		APPEARANCES.map((appearance) => {
			...
			const variables = Object.fromEntries(
				MOBILE_THEME_VARIABLE_NAMES.map((name) => {
					const match = new RegExp(`^\\s*${name}:\\s*([^;]+);`, "mu").exec(
						body,
					);
					if (!match?.[1]) {
...
> => [
	...
	[
		...
		renderDefaultThemeVariablesJSON(
			NodeFS.readFileSync(GLOBAL_CSS_PATH, "utf8"),
		),
	],
];

const writeFileAtomically = (filename: string, contents: string) => {
	const current = NodeFS.existsSync(filename)
	...
	try {
		...
		if (NodeFS.existsSync(temporaryFilename))
			NodeFS.unlinkSync(temporaryFilename);
	}
};
