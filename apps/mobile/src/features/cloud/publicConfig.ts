...
type ExpoExtra =
	| {
			readonly [Section in keyof CloudPublicConfig]?: UntrustedSection<
				CloudPublicConfig[Section]
			>;
	  }
	| undefined;
...
export function hasCloudPublicConfig(): boolean {
	...
	return Boolean(
		config.clerk.publishableKey && config.clerk.jwtTemplate && config.relay.url,
	);
}
