...
export function WorkspaceInspectorPane(props: {
	...
	const inspectorSupported =
		props.renderInspector !== undefined && inspectorWidth !== null;
	...
	const renderedInspectorWidth = useSharedValue(
		inspectorVisible ? (inspectorWidth ?? 0) : 0,
	);
	...
	const inspectorContentStyle = useAnimatedStyle(
		() => ({ width: renderedContentWidth.value }),
		[],
	);
			...
			{inspectorSupported ? (
				<Animated.View
					...
					importantForAccessibility={
						inspectorVisible ? "auto" : "no-hide-descendants"
					}
