...
describe("resolveReviewHighlighterEnginePreference", () => {
	...
	it("accepts supported values", () => {
		expect(resolveReviewHighlighterEnginePreference("javascript")).toBe(
			"javascript",
		);
...
describe("resolveReviewHighlighterEngine", () => {
	it("uses javascript when explicitly requested", () => {
		expect(resolveReviewHighlighterEngine("javascript", true)).toBe(
			"javascript",
		);
		expect(resolveReviewHighlighterEngine("javascript", false)).toBe(
			"javascript",
		);
	});
