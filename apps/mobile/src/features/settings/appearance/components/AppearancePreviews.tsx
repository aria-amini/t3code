	...
	return (
		<View className="p-4">
			...
			<Text style={span(theme.foreground)}>
				...
				<Text
					style={span(theme.palette[6], { textDecorationLine: "underline" })}
				>
					http://127.0.0.1:5173/
				</Text>
			</Text>
			...
			<Text style={span(theme.foreground)}>
				<Text
					style={span(theme.background, { backgroundColor: theme.palette[2] })}
				>
					{" READY "}
				</Text>
...
export function CodeAppearancePreview(props: {
	...
	return (
		<View className="flex-row p-4">
			<View>
				{CODE_PREVIEW_LINES.map((line, index) => lineNumber(line, index))}
			</View>
			<ScrollView
				horizontal
