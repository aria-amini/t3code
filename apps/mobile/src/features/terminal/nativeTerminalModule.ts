...
let cachedNativeTerminalSurfaceView:
	| ComponentType<NativeTerminalSurfaceProps>
	| undefined;
...
export function resolveNativeTerminalSurfaceView(): ComponentType<NativeTerminalSurfaceProps> | null {
	...
	try {
		cachedNativeTerminalSurfaceView =
			requireNativeView<NativeTerminalSurfaceProps>(
