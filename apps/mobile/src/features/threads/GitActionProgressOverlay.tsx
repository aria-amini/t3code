...
export function GitActionProgressOverlay(props: {
	...
	return (
		<Animated.View
			entering={
				NATIVE_LIQUID_GLASS_SUPPORTED ? undefined : FadeIn.duration(200)
			}
...
function OverlayContent(props: { readonly progress: GitActionProgress }) {
	...
	const glassTint = themeColorWithAlpha(
		String(glassSurface),
		isDarkMode ? 0.48 : 0.38,
	);
	const glassBorder = themeColorWithAlpha(
		String(foreground),
