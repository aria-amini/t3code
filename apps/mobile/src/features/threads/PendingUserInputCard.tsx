...
export function PendingUserInputCard(props: PendingUserInputCardProps) {
	...
	const bar = showBar ? (
		<View
			...
			importantForAccessibility={
				props.collapsed ? "auto" : "no-hide-descendants"
			}
	...
	const card = renderCard ? (
		...
		<Animated.View
			...
			accessibilityElementsHidden={props.collapsed}
			importantForAccessibility={
				props.collapsed ? "no-hide-descendants" : "auto"
			}
			entering={
				EXPANDED_CARD_IS_OVERLAY
					? undefined
					: FadeInUp.duration(USER_INPUT_TOGGLE_DURATION_MS).easing(
			...
			exiting={
				EXPANDED_CARD_IS_OVERLAY
					? undefined
					: FadeOutDown.duration(USER_INPUT_TOGGLE_DURATION_MS).easing(
							Easing.out(Easing.cubic),
						)
			}
