...
export type MarkdownHighlightedCode = ReadonlyArray<
...
class MarkdownCodeHighlightError extends Data.TaggedError(
	"MarkdownCodeHighlightError",
)<{
...
export function createMarkdownCodeHighlightAtomFamily(options?: {
	...
	return (input: MarkdownCodeHighlightInput) =>
		family(new MarkdownCodeHighlightCacheKey(input));
}

export const markdownCodeHighlightAtom =
