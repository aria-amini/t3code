...
export const make = Effect.gen(function* () {
	...
	const getTurnDiff: CheckpointDiffQuery["Service"]["getTurnDiff"] = Effect.fn(
		"getTurnDiff",
	)(function* (input) {
	...
	const getFullThreadDiff: CheckpointDiffQuery["Service"]["getFullThreadDiff"] =
		Effect.fn("CheckpointDiffQuery.getFullThreadDiff")(function* (input) {
