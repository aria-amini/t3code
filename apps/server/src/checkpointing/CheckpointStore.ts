...
export const make = Effect.gen(function* () {
	...
	const resolveCheckpoints = Effect.fn("CheckpointStore.resolveCheckpoints")(
	...
	const captureCheckpoint: CheckpointStore["Service"]["captureCheckpoint"] =
		Effect.fn("captureCheckpoint")(function* (input) {
	...
	const hasCheckpointRef: CheckpointStore["Service"]["hasCheckpointRef"] =
		Effect.fn("hasCheckpointRef")(function* (input) {
			const checkpoints = yield* resolveCheckpoints(
	...
	const restoreCheckpoint: CheckpointStore["Service"]["restoreCheckpoint"] =
		Effect.fn("restoreCheckpoint")(function* (input) {
			const checkpoints = yield* resolveCheckpoints(
	...
	const diffCheckpoints: CheckpointStore["Service"]["diffCheckpoints"] =
		Effect.fn("diffCheckpoints")(function* (input) {
			const checkpoints = yield* resolveCheckpoints(
	...
	const deleteCheckpointRefs: CheckpointStore["Service"]["deleteCheckpointRefs"] =
		Effect.fn("deleteCheckpointRefs")(function* (input) {
			const checkpoints = yield* resolveCheckpoints(
