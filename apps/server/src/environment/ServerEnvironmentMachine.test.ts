...
describe("machineKindFromAppleProductName", () => {
	it("maps marketing names and model identifiers", () => {
		...
		expect(machineKindFromAppleProductName("Mac Studio (2023)")).toBe(
			"mac-studio",
		);
		expect(machineKindFromAppleProductName("MacBook Pro (14-inch, 2024)")).toBe(
			"laptop",
		);
		expect(machineKindFromAppleProductName("MacBookAir10,1")).toBe("laptop");
		expect(machineKindFromAppleProductName("iMac (24-inch, 2024)")).toBe(
			"desktop",
		);
