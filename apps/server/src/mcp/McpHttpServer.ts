		...
		Effect.fn("McpHttpServer.authenticateRequest")(function* (httpEffect) {
			...
			if (!invocation) {
				...
				yield* Effect.logWarning(
					"rejected MCP request with an unusable credential",
					{
						reason:
							token.length === 0
...
const registerPreviewSnapshot = Effect.fn(
	"McpHttpServer.registerPreviewSnapshot",
)(function* () {
...
const PreviewStandardToolkitRegistrationLive = McpServer.toolkit(
	PreviewStandardToolkit,
