...
export const orchestrationEventsProcessedTotal = Metric.counter(
	...
	{
		description:
			"Total orchestration intent events processed by runtime reactors.",
	},
);

export const providerSessionsTotal = Metric.counter(
...
export const terminalSessionsTotal = Metric.counter(
...
export const terminalRestartsTotal = Metric.counter(
