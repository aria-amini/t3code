...
export type OrchestrationCommandRejection =
	typeof OrchestrationCommandRejection.Type;
export const isOrchestrationCommandRejection = Schema.is(
...
export function toListenerCallbackError(
	listener: "read-model" | "domain-event",
) {
