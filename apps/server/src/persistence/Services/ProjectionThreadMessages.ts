...
export type ListProjectionThreadMessagesInput =
	typeof ListProjectionThreadMessagesInput.Type;

export const GetProjectionThreadMessageInput = Schema.Struct({
	messageId: MessageId,
});
export type GetProjectionThreadMessageInput =
	typeof GetProjectionThreadMessageInput.Type;
...
export type DeleteProjectionThreadMessagesInput =
	typeof DeleteProjectionThreadMessagesInput.Type;
...
export interface ProjectionThreadMessageRepositoryShape {
	...
	readonly getByMessageId: (
		...
		Option.Option<ProjectionThreadMessage>,
	...
	readonly getLatestUserMessageAt: (
		...
		ProjectionThreadMessage["createdAt"] | null,
		ProjectionRepositoryError
	>;
