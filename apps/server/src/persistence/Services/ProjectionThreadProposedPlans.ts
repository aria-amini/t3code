...
export type ProjectionThreadProposedPlan =
	typeof ProjectionThreadProposedPlan.Type;
...
export type GetProjectionThreadProposedPlanInput =
	typeof GetProjectionThreadProposedPlanInput.Type;
...
export interface ProjectionThreadProposedPlanRepositoryShape {
	...
	readonly getByPlanId: (
		...
		Option.Option<ProjectionThreadProposedPlan>,
