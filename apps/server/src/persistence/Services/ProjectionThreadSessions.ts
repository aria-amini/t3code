...
export type GetProjectionThreadSessionInput =
	typeof GetProjectionThreadSessionInput.Type;

export const DeleteProjectionThreadSessionInput = Schema.Struct({
	threadId: ThreadId,
});
export type DeleteProjectionThreadSessionInput =
	typeof DeleteProjectionThreadSessionInput.Type;
...
export interface ProjectionThreadSessionRepositoryShape {
	...
	readonly getByThreadId: (
		...
		Option.Option<ProjectionThreadSession>,
