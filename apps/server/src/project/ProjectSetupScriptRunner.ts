...
export type ProjectSetupScriptRunnerError =
	typeof ProjectSetupScriptRunnerError.Type;
...
export const make = Effect.gen(function* () {
	...
	const runForThread: ProjectSetupScriptRunner["Service"]["runForThread"] =
		Effect.fn("ProjectSetupScriptRunner.runForThread")(function* (input) {
			const errorContext = {
