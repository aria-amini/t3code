...
function pickPrimaryRemote(
	...
	const [remoteName, remoteUrl] =
		[...remotes.entries()].toSorted(([left], [right]) =>
...
function buildRepositoryIdentity(input: {
	...
	const repositoryPathSegments = repositoryPath
		.split("/")
...
const resolveRepositoryIdentityCacheKey = Effect.fn(
	"RepositoryIdentityResolver.resolveCacheKey",
)(function* (cwd: string) {
...
export const make = Effect.fn("RepositoryIdentityResolver.make")(function* (
	...
	const processRunner = yield* ProcessRunner.ProcessRunner;
	const cacheCapacity =
		options.cacheCapacity ?? DEFAULT_REPOSITORY_IDENTITY_CACHE_CAPACITY;
