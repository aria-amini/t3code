 ...
 */
const WINDOWS_SHIM_EXTENSIONS: ReadonlySet<string> = new Set([
	".cmd",
	".bat",
	".ps1",
]);
 ...
 */
export const resolveClaudeSdkExecutablePath = Effect.fn(
	...
	const resolved =
		resolveExecutable(binaryPath, platform, environment) ?? binaryPath;
