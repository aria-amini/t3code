...
export const resolveClaudeHomePath = Effect.fn("resolveClaudeHomePath")(
	function* (
		...
		return path.resolve(
			homePath.length > 0 ? expandHomePath(homePath) : NodeOS.homedir(),
		);
	},
);

export const makeClaudeEnvironment = Effect.fn("makeClaudeEnvironment")(
	function* (
		config: Pick<ClaudeSettings, "homePath">,
...
export const makeClaudeContinuationGroupKey = Effect.fn(
...
export const makeClaudeCapabilitiesCacheKey = Effect.fn(
