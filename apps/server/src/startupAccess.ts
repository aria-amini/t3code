...
export const resolveHeadlessConnectionHost = (
	...
	const interfaceEntries = Object.values(interfaces).flatMap(
		(entries) => entries ?? [],
	);
...
export const formatHeadlessServeOutput = (
...
export const issueHeadlessServeAccessInfo = Effect.fn(
