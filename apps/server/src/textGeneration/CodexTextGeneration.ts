 ...
 */
export const makeCodexTextGeneration = Effect.fn("makeCodexTextGeneration")(
	function* (codexConfig: CodexSettings, environment?: NodeJS.ProcessEnv) {
		...
		const materializeImageAttachments = Effect.fn(
		...
		const runCodexJson = Effect.fn("runCodexJson")(function* <
		...
		> {
			...
			const runCodexCommand = Effect.fn("runCodexJson.runCodexCommand")(
				function* () {
