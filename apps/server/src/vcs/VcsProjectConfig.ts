...
const decodeProjectVcsConfigJson =
	Schema.decodeUnknownEffect(ProjectVcsConfigJson);
...
function configuredKind(
	config: ProjectVcsConfigFile,
): VcsDriverKindType | "auto" {
...
export const make = Effect.gen(function* () {
	...
	const findConfigPath = Effect.fn("VcsProjectConfig.findConfigPath")(
		function* (cwd: string) {
			let current = cwd;
			while (true) {
	...
	const readConfiguredKind = Effect.fn("VcsProjectConfig.readConfiguredKind")(
		function* (cwd: string, configPath: string) {
