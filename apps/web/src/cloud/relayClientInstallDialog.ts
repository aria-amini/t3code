...
export class RelayClientInstallConfirmationConflictError extends Schema.TaggedErrorClass<RelayClientInstallConfirmationConflictError>()(
	"RelayClientInstallConfirmationConflictError",
	{
		...
		activeDialogStatus: Schema.Literals([
			"confirming",
			"installing",
			"closing",
		]),
...
export function requestRelayClientInstallConfirmation(
	version: string,
): Promise<boolean> {
...
export function respondToRelayClientInstallConfirmation(
	confirmed: boolean,
): void {
...
export function reportRelayClientInstallProgress(
