...
export function PullRequestThreadDialog({
	...
	const preparePullRequestThreadAction =
		usePreparePullRequestThreadAction(sourceControlScope);
		...
		>
			<DialogPopup className="max-w-xl">
				<DialogHeader>
					...
					<DialogDescription>
						Resolve a {sourceControlPresentation.providerName}{" "}
						{terminology.singular}, then create the draft thread in the main
						repo or in a dedicated worktree.
					</DialogDescription>
				</DialogHeader>
