	...
	return (
		...
		>
			<defs>
				...
				>
					<stop
						style={{ stopColor: "var(--stage-night-glow-highlight)" }}
						stopOpacity="0.4"
					/>
					<stop
						offset="0.5"
					...
					<stop
						offset="1"
						style={{ stopColor: "var(--stage-night-bottom)" }}
						stopOpacity="0"
					/>
				</radialGradient>
				<linearGradient
				...
				>
					...
					<stop
						offset="1"
						style={{ stopColor: "var(--stage-night-tertiary)" }}
						stopOpacity="0.5"
					/>
				</linearGradient>
				<filter
					...
					>
						{NIGHTLY_SPARKLES.map((sparkle) => (
							<g key={`${sparkle.x}-${sparkle.y}`}>
								<path
									d={`M${sparkle.x - 1.5} ${sparkle.y}H${sparkle.x + 1.5}`}
								/>
								<path
									d={`M${sparkle.x} ${sparkle.y - 1.5}V${sparkle.y + 1.5}`}
								/>
							</g>
						))}
					</g>
	...
	return (
		...
		>
			<defs>
				...
				>
					<stop
						style={{ stopColor: "var(--stage-art-highlight)" }}
						stopOpacity="0.4"
					/>
					<stop
						offset="0.52"
					...
					<stop
						offset="1"
						style={{ stopColor: "var(--stage-art-bottom)" }}
						stopOpacity="0"
					/>
				</radialGradient>
				<radialGradient
				...
				>
					<stop
						style={{ stopColor: "var(--stage-art-celeste-highlight)" }}
						stopOpacity="0.34"
					/>
					<stop
						offset="0.5"
				...
				>
					<stop
						style={{ stopColor: "var(--stage-art-violet-highlight)" }}
						stopOpacity="0.3"
					/>
					<stop
						offset="0.52"
