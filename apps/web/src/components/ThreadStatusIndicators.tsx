...
export interface LinkedThreadPullRequestStatus {
	...
	readonly sourceControlProvider: NonNullable<
		VcsStatusResult["sourceControlProvider"]
	>;
}
...
export function PrStatusTooltipContent({
	...
	return (
		<span className="flex max-w-[min(34rem,calc(100vw-2rem))] items-stretch overflow-hidden whitespace-nowrap">
			...
			<span
				className="min-h-4 shrink-0 border-border/70 border-l"
				aria-hidden="true"
			/>
