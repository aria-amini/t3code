...
type ComposerSelectControlProps = Omit<
	...
	return (
		<Button
			className={cn(
				...
				size === "xs"
					? restingComposerControlClassName
					: expandedComposerControlClassName,
				className,
			)}
			size={size}
			variant={variant}
	...
	return (
		<ChevronDownIcon
			...
			className={cn(
				"shrink-0",
				size === "xs"
					? "size-3 text-current opacity-50"
					: "size-3.5 text-icon-muted",
				className,
			)}
