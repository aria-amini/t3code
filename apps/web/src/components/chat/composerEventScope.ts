...
export function isInsideComposerFloatingLayer(
	target: EventTarget | null,
): boolean {
	return (
		target instanceof Element &&
		target.closest(COMPOSER_FLOATING_LAYER_SELECTOR) !== null
	);
}
...
export function isInsideCollapsedComposerControls(
	target: EventTarget | null,
): boolean {
	return (
		target instanceof Element &&
...
export function isInsideRestingComposerControlScope(
	target: EventTarget | null,
): boolean {
	return (
		target instanceof Element &&
