	...
	const event = {
		dataTransfer: {
			...
			getData: (format: string) =>
				format === COMPOSER_MENTION_DRAG_TYPE ? mention : "",
			dropEffect: "none",
		},
		nativeEvent: {
...
describe("composerMentionFromTreePath", () => {
	it("serializes a file path into a mention", () => {
		expect(composerMentionFromTreePath("docs/index.md")).toBe(
