...
export const MOBILE_DRAFT_HEADLINE_VIEW_TRANSITION_NAME =
...
export async function runMobileComposerTransition(
	...
	transitionDocument.documentElement.dataset.mobileComposerRouteTransition =
		"true";
	try {
		...
		delete transitionDocument.documentElement.dataset
			.mobileComposerRouteTransition;
	}
}
