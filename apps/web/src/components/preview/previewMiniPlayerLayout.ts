...
export interface PreviewMiniPlayerFrame
	extends PreviewMiniPlayerPosition, PreviewMiniPlayerSize {}
...
export function resolvePreviewMiniPlayerSourceSize(
	...
	const fitted = resolveFittedBrowserViewport(
		viewport,
		fittedSourceContent,
...
export function resolvePreviewMiniPlayerFrame(input: {
	...
	return {
		...clampPreviewMiniPlayerPosition(anchored, container, size, bottomInset),
		...size,
	};
}
