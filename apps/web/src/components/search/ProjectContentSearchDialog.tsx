...
interface MatchGroup {
	...
	readonly matches: ReadonlyArray<
		ProjectContentMatch & { readonly resultIndex: number }
	>;
}
...
function groupMatches(
	...
	const groups = new Map<
		string,
		Array<ProjectContentMatch & { readonly resultIndex: number }>
	>();
...
function OpenContentSearchDialog(props: {
	...
	const observeLoadMoreSentinel = useCallback(
	...
	const openMatch = (match: ProjectContentMatch) => {
		...
		useRightPanelStore
			.getState()
			.openFile(target.threadRef, match.path, match.lineNumber);
	};
...
export function ProjectContentSearchDialog(
	props: ProjectContentSearchDialogProps,
) {
