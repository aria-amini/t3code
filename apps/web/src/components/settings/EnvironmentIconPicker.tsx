...
export function EnvironmentIconPicker({
	...
	const lock = resolveEnvironmentIconPickerLock({
		serverConfig,
		operateAccess,
	});
	...
	const automaticLabel =
		detected === null
			? "Automatic"
			: `Automatic (${ENVIRONMENT_MACHINE_KIND_LABELS[detected]})`;
				...
				<SelectValue>
					<span className="flex min-w-0 items-center gap-2">
						...
						<span className="truncate">
							{override === null
								? automaticLabel
								: ENVIRONMENT_MACHINE_KIND_LABELS[override]}
						</span>
					</span>
				</SelectValue>
			</SelectTrigger>
