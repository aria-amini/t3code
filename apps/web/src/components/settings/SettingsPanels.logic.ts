...
export function isProjectGroupingEnabled(
...
export function rememberEnabledProjectGroupingMode(
	mode: SidebarProjectGroupingMode,
): void {
...
export function hasChangedBackgroundActivitySettings(
	...
	return (
		...
		settings.backgroundActivityProfile !==
...
export function getChangedBrowserSettingLabels(
	...
	return [
		...
		DEFAULT_UNIFIED_SETTINGS.browserDefaultZoomFactor
			? ["Browser zoom"]
			: []),
		...(settings.browserDefaultAppearance !==
		DEFAULT_UNIFIED_SETTINGS.browserDefaultAppearance
			? ["Browser appearance"]
			: []),
		...(settings.browserRecordingFrameRate !==
		DEFAULT_UNIFIED_SETTINGS.browserRecordingFrameRate
...
export function formatDiagnosticsDescription(input: {
	...
	const metricsUrl = input.otlpMetricsEnabled
		? input.otlpMetricsUrl
		: undefined;
...
export function buildProviderInstanceUpdatePatch(input: {
	...
	type LegacyProviderSettings =
		ServerSettings["providers"][keyof ServerSettings["providers"]];
