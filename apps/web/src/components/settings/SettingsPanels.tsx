...
export function useSettingsRestore(onRestored?: () => void) {
	...
	const changedSettingLabels = useMemo(
		() => [
			...
			DEFAULT_UNIFIED_SETTINGS.appearanceContrast
				? ["Contrast"]
				: []),
			...
			DEFAULT_UNIFIED_SETTINGS.confirmThreadUnpin
				? ["Unpin confirmation"]
				: []),
						...
						<div className="grid w-full grid-cols-[5rem_minmax(0,1fr)] items-center gap-3 sm:w-auto sm:grid-cols-[7rem_13rem] sm:gap-4">
							...
							<div className="flex w-full items-center gap-3">
								...
								<input
									...
									onChange={(event) => {
										const panelAnimationDurationMs = Number(
				...
				<SettingsRow
					...
					control={
						...
						>
							...
							>
								<SelectValue>
									{DIFF_LAYOUT_LABELS[settings.diffLayout]}
								</SelectValue>
							</SelectTrigger>
							<SelectPopup align="end" alignItemWithTrigger={false}>
					...
					<SettingsRow
						...
						control={
							...
							>
								...
								<SelectPopup align="end" alignItemWithTrigger={false}>
									{Object.entries(QUIT_CONFIRMATION_MODE_LABELS).map(
										([value, label]) => (
											<SelectItem hideIndicator key={value} value={value}>
												{label}
											</SelectItem>
