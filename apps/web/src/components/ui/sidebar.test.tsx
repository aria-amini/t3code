...
describe("sidebar interactive cursors", () => {
	it("uses mobile sheet visibility for the shared responsive state", () => {
		expect(
			resolveSidebarState({ isMobile: true, open: true, openMobile: false }),
		).toBe("collapsed");
		expect(
			resolveSidebarState({ isMobile: true, open: false, openMobile: true }),
		).toBe("expanded");
		expect(
			resolveSidebarState({ isMobile: false, open: true, openMobile: false }),
		).toBe("expanded");
	});
