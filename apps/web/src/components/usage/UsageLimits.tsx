...
const PACE: Record<
	LimitPace,
	{ readonly label: string; readonly icon: typeof GaugeIcon }
> = {
	ahead: {
...
function WindowBar({
	...
	const timestampFormat = usePrimarySettings(
		...
		<AlertDialog open={open} onOpenChange={onOpenChange}>
			<AlertDialogPopup>
				<AlertDialogHeader>
					...
					<AlertDialogDescription>
						This redeems one credit on your account and clears the current
						rate-limit windows. It cannot be undone.
					</AlertDialogDescription>
				</AlertDialogHeader>
				<AlertDialogFooter>
