...
export function normalizeElementContextSelection(
	...
	return {
		...
		htmlPreview: truncateString(
			normalizeText(raw.htmlPreview),
		...
		source: stackFrame
			...
			: null,
		styles: truncateString(
			normalizeText(raw.styles),
 ...
 */
export function elementContextDedupKey(
 ...
 */
export function formatElementContextLabel(
	context: ElementContextSelection,
): string {
...
export function formatElementContextSourceLabel(
	context: ElementContextSelection,
): string | null {
 ...
 */
export function extractTrailingElementContexts(
	prompt: string,
): ExtractedElementContexts {
...
function parseElementContextEntries(
	block: string,
): ParsedElementContextEntry[] {
