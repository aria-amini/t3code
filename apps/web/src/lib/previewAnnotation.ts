...
export function buildPreviewAnnotationPrompt(
...
export function extractTrailingPreviewAnnotation(
	prompt: string,
	...
	const elementContextIndex =
		linesAfterStyleHeading.indexOf("<element_context>");
	const styleChanges =
		styleHeadingIndex < 0
			? []
