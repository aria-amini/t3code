...
import {
	ApnsEnvironment as ApnsEnvironmentSchema,
...
const ApnsRequestKindSchema = Schema.Literals([
	"live-activity",
	"push-notification",
]);
...
function makeLiveActivityRequest(
				...
				aps: {
					...
					"dismissal-date":
						...
						(input.state
							...
							: CONTENTLESS_DISMISS_AFTER_SECONDS),
				},
			},
		};
	}
...
export const make = Effect.gen(function* () {
	...
	const sendLiveActivityRequest: ApnsClient["Service"]["sendLiveActivityRequest"] =
		Effect.fn("relay.apns.send_live_activity_request")(function* (input) {
