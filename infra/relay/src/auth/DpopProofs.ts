...
const make = Effect.gen(function* () {
	...
	const consume: DpopProofReplay["Service"]["consume"] = Effect.fn(
		"relay.dpop_proofs.consume",
	)(function* (input) {
	...
	const verifyAndConsume: DpopProofReplay["Service"]["verifyAndConsume"] =
		Effect.fn("relay.dpop_proofs.verify_and_consume")(function* (input) {
			yield* Effect.annotateCurrentSpan({
				"relay.dpop.method": input.method,
				"relay.dpop.expected_thumbprint_present":
					input.expectedThumbprint !== undefined,
				"relay.dpop.expected_access_token_present":
	...
	const pruneExpired: DpopProofReplay["Service"]["pruneExpired"] = Effect.gen(
		function* () {
