...
export class ManagedEndpointAllocations extends Context.Service<
	ManagedEndpointAllocations,
	{
		readonly get: (
			...
			ManagedEndpointAllocation | null,
			ManagedEndpointAllocationPersistenceError
		>;
		readonly reserve: (
...
export const make = Effect.gen(function* () {
	...
	return ManagedEndpointAllocations.of({
		...
		recordTunnel: Effect.fn("relay.managed_endpoint_allocations.record_tunnel")(
			function* (input: RecordManagedEndpointTunnelInput) {
				yield* db
		...
		recordDns: Effect.fn("relay.managed_endpoint_allocations.record_dns")(
		...
		markReady: Effect.fn("relay.managed_endpoint_allocations.mark_ready")(
		...
		claimRelease: Effect.fn("relay.managed_endpoint_allocations.claim_release")(
			function* (input: ClaimManagedEndpointReleaseInput) {
		...
		claimDeprovision: Effect.fn(
			"relay.managed_endpoint_allocations.claim_deprovision",
		)(function* (input: ClaimManagedEndpointDeprovisionInput) {
		...
		removeClaimed: Effect.fn(
			"relay.managed_endpoint_allocations.remove_claimed",
		)(function* (input: RemoveClaimedManagedEndpointAllocationInput) {
			return yield* db
				.delete(relayManagedEndpointAllocations)
				.where(
					and(
