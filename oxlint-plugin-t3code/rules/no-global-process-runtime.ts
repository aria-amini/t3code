	...
	createOnce(context) {
		...
		return {
			...
			MemberExpression(node) {
				...
				if (Option.isNone(property) || !RUNTIME_PROPERTIES.has(property.value))
					return;
