...
export type BrowserImportUnavailableReason =
	typeof BrowserImportUnavailableReason.Type;
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<
...
export const BROWSER_IMPORT_FAILURE_COPY: Readonly<
	Record<BrowserImportFailureReason, string>
> = {
