...
export const DesktopAppActivationPlatform = Schema.Literals([
	"darwin",
	"linux",
	"win32",
]);
export type DesktopAppActivationPlatform =
	typeof DesktopAppActivationPlatform.Type;
...
export type DesktopAppActivationRequest =
	typeof DesktopAppActivationRequest.Type;
...
export type DesktopAppActivationErrorCode =
	typeof DesktopAppActivationErrorCode.Type;
...
export type DesktopAppActivationSuccess =
	typeof DesktopAppActivationSuccess.Type;
...
export type DesktopAppActivationFailure =
	typeof DesktopAppActivationFailure.Type;

export const DesktopAppActivationResponse = Schema.Union([
	DesktopAppActivationSuccess,
	DesktopAppActivationFailure,
]);
export type DesktopAppActivationResponse =
	typeof DesktopAppActivationResponse.Type;
