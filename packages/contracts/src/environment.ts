...
export type ExecutionEnvironmentPlatformOs =
	typeof ExecutionEnvironmentPlatformOs.Type;

export const ExecutionEnvironmentPlatformArch = Schema.Literals([
	"arm64",
	"x64",
	"other",
]);
export type ExecutionEnvironmentPlatformArch =
	typeof ExecutionEnvironmentPlatformArch.Type;
...
export type ExecutionEnvironmentPlatform =
	typeof ExecutionEnvironmentPlatform.Type;
...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
	repositoryIdentity: Schema.Boolean.pipe(
...
export type ExecutionEnvironmentCapabilities =
	typeof ExecutionEnvironmentCapabilities.Type;
...
export type ExecutionEnvironmentDescriptor =
	typeof ExecutionEnvironmentDescriptor.Type;
