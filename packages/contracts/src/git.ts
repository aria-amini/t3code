...
const VcsStatusChangeRequestState = Schema.Literals([
	"open",
	"closed",
	"merged",
]);
...
export type GitRunStackedActionToastRunAction =
	typeof GitRunStackedActionToastRunAction.Type;
...
export type GitRunStackedActionToastCta =
	typeof GitRunStackedActionToastCta.Type;
...
export const VcsListRefsInput = Schema.Struct({
	...
	query: Schema.optional(
		TrimmedNonEmptyStringSchema.check(Schema.isMaxLength(256)),
	),
...
export const GitPreparePullRequestThreadResult = Schema.Struct({
	 ...
	 */
	isOnPullRequestHead: Schema.Boolean.pipe(
...
export class GitManagerError extends Schema.TaggedError<GitManagerError>()(
	"GitManagerError",
	{
		operation: Schema.String,
		cwd: Schema.String,
