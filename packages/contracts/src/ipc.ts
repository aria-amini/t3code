...
export const ContextMenuItemSchema: Schema.Codec<ContextMenuItemSchemaType> =
	Schema.Struct({
		id: Schema.String,
		label: Schema.String,
		...
		children: Schema.optionalKey(
			Schema.Array(
				Schema.suspend(
					(): Schema.Codec<ContextMenuItemSchemaType> => ContextMenuItemSchema,
				),
			),
		),
	});
...
export const DesktopRuntimeArchSchema = Schema.Literals([
	"arm64",
	"x64",
	"other",
]);
...
export const DesktopSnapShotMode = Schema.Literals([
	"direct",
	"portal",
	"unavailable",
]);
...
export type DesktopCaptureExtensionState =
	typeof DesktopCaptureExtensionState.Type;
...
export type DesktopCaptureConfigRequest =
	typeof DesktopCaptureConfigRequest.Type;
...
export type DesktopCaptureConfigPreview =
	typeof DesktopCaptureConfigPreview.Type;
...
export type DesktopCaptureConfigApplied =
	typeof DesktopCaptureConfigApplied.Type;

export const DesktopSnapShotState = Schema.Struct({
	mode: DesktopSnapShotMode,
	windows: Schema.optional(Schema.Boolean),
	linuxDesktop: Schema.optional(
		Schema.Literals(["gnome", "kde", "niri", "hyprland"]),
	),
...
export type DesktopSnapShotShortcutAvailability =
	typeof DesktopSnapShotShortcutAvailability.Type;
...
export type DesktopSnapShotAnimationDestination =
	typeof DesktopSnapShotAnimationDestination.Type;
...
export const DesktopUpdateStateSchema = Schema.Struct({
	...
	message: Schema.NullOr(Schema.String),
	errorContext: Schema.NullOr(
		Schema.Literals(["check", "download", "install"]),
	),
...
export type DesktopSshEnvironmentTarget =
	typeof DesktopSshEnvironmentTargetSchema.Type;

export type DesktopSshHostSource = "ssh-config" | "known-hosts";
export const DesktopSshHostSourceSchema = Schema.Literals([
	"ssh-config",
	"known-hosts",
]);
...
export const DesktopSshEnvironmentBootstrapSchema = Schema.Struct({
	...
	remoteServerKind: Schema.optionalKey(
		Schema.Literals(["external", "managed"]),
	),
});
...
export const DesktopSshPasswordPromptCancelledType =
	"ssh-password-prompt-cancelled" as const;
...
export type PersistedSavedEnvironmentRecord =
	typeof PersistedSavedEnvironmentRecordSchema.Type;
...
export const DesktopPreviewFaviconSchema: Schema.Codec<DesktopPreviewFavicon> =
	Schema.Struct({
...
export const DesktopPreviewTabIdSchema = Schema.String.check(
	Schema.isTrimmed(),
...
export type DesktopPreviewAutomationStatus =
	typeof DesktopPreviewAutomationStatusSchema.Type;
...
export const PickedElementStackFrameSchema: Schema.Codec<PickedElementStackFrame> =
	Schema.Struct({
...
export const PickedElementPayloadSchema: Schema.Codec<PickedElementPayload> =
	Schema.Struct({
...
export const PreviewAnnotationRectSchema: Schema.Codec<PreviewAnnotationRect> =
	Schema.Struct({
		x: Schema.Number,
		y: Schema.Number,
		width: Schema.Number,
...
export const PreviewAnnotationPointSchema: Schema.Codec<PreviewAnnotationPoint> =
	Schema.Struct({
		x: Schema.Number,
		y: Schema.Number,
	});
...
export const PreviewAnnotationPayloadSchema: Schema.Codec<PreviewAnnotationPayload> =
	Schema.Struct({
		id: Schema.String,
		pageUrl: Schema.String,
		pageTitle: Schema.NullOr(Schema.String),
...
export interface DesktopBridge {
	...
	applySnapShotConfig?: (
		previewId: string,
	) => Promise<DesktopCaptureConfigApplied>;
	...
	onSnapShotEvent?: (
		listener: (event: DesktopSnapShotEvent) => void,
	) => () => void;
	/**
	 ...
	 */
	onQuitShortcut?: (
		listener: (event: QuitShortcutHintEvent) => void,
	) => () => void;
	...
	appActivation?: {
		...
		onRequest: (
			listener: (request: DesktopAppActivationRequest) => void,
		) => () => void;
	};
	/**
...
export const DESKTOP_PREVIEW_RECORDING_CAPTURE_TRIGGER =
	"__t3DesktopPreviewRecordingCapture";
...
export interface EnvironmentApi {
	...
	review: {
		...
		) => Promise<ReviewDiffPreviewResult>;
		getDiffFileContents: (
	...
	preview: {
		open: (
			input: typeof PreviewOpenInput.Encoded,
		) => Promise<PreviewSessionSnapshot>;
		navigate: (
			input: typeof PreviewNavigateInput.Encoded,
		) => Promise<PreviewSessionSnapshot>;
		resize: (
			input: typeof PreviewResizeInput.Encoded,
		) => Promise<PreviewSessionSnapshot>;
		refresh: (input: typeof PreviewRefreshInput.Encoded) => Promise<void>;
		close: (input: typeof PreviewCloseInput.Encoded) => Promise<void>;
		list: (
			input: typeof PreviewListInput.Encoded,
		) => Promise<PreviewListResult>;
		reportStatus: (
			input: typeof PreviewReportStatusInput.Encoded,
		) => Promise<void>;
		automation: {
			connect: (
