...
export type ThreadKeybindingCommand =
	(typeof THREAD_KEYBINDING_COMMANDS)[number];

const MODEL_PICKER_KEYBINDING_COMMANDS = [
	"modelPicker.toggle",
	...MODEL_PICKER_JUMP_KEYBINDING_COMMANDS,
] as const;
export type ModelPickerKeybindingCommand =
	(typeof MODEL_PICKER_KEYBINDING_COMMANDS)[number];
 ...
 */
export const ResolvedKeybindingsConfig = ForwardCompatibleArray(
