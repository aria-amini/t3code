...
export const PullRequestInvolvement = Schema.Literals([
	"all",
	"reviewing",
	"authored",
]);
...
const PullRequestQualifierValue = TrimmedNonEmptyString.check(
	Schema.isMaxLength(200),
);
const PullRequestQualifierValues = Schema.Array(
	PullRequestQualifierValue,
...
export const PullRequestListFilters = Schema.Struct({
	...
	labels: Schema.optional(
		Schema.Array(PullRequestQualifierValues).check(Schema.isMaxLength(10)),
	),
...
export const PullRequestChecksState = Schema.Literals([
	"passing",
	"failing",
	"pending",
]);
 ...
 */
export const PullRequestBaseComparison = Schema.Literals([
	"up-to-date",
	"behind",
	"unknown",
]);
...
export type PullRequestLabelCandidateList =
	typeof PullRequestLabelCandidateList.Type;
...
export type PullRequestReviewCapabilities =
	typeof PullRequestReviewCapabilities.Type;
...
export type PullRequestEditCapabilities =
	typeof PullRequestEditCapabilities.Type;
...
export type PullRequestReviewerCapabilities =
	typeof PullRequestReviewerCapabilities.Type;
...
export type PullRequestViewerPermissions =
	typeof PullRequestViewerPermissions.Type;
...
export type PullRequestListProjectError =
	typeof PullRequestListProjectError.Type;
...
export type PullRequestDiffFileContentsInput =
	typeof PullRequestDiffFileContentsInput.Type;

export const PullRequestDiffFileContentsResult = Schema.Struct({
	oldContents: Schema.String,
	newContents: Schema.String,
});
export type PullRequestDiffFileContentsResult =
	typeof PullRequestDiffFileContentsResult.Type;
...
const CommentBody = Schema.String.check(Schema.isNonEmpty()).check(
...
export type PullRequestCommentUpdateInput =
	typeof PullRequestCommentUpdateInput.Type;
...
export type PullRequestSubmitReviewInput =
	typeof PullRequestSubmitReviewInput.Type;
...
export type PullRequestThreadCommentsInput =
	typeof PullRequestThreadCommentsInput.Type;

export const PullRequestThreadCommentsResult = Schema.Struct({
	comments: Schema.Array(PullRequestThreadComment),
	nextCursor: Schema.NullOr(TrimmedNonEmptyString),
});
export type PullRequestThreadCommentsResult =
	typeof PullRequestThreadCommentsResult.Type;
...
export type PullRequestThreadReplyInput =
	typeof PullRequestThreadReplyInput.Type;
...
export type PullRequestThreadResolutionInput =
	typeof PullRequestThreadResolutionInput.Type;
...
export type PullRequestReviewerRequestInput =
	typeof PullRequestReviewerRequestInput.Type;
...
export const PullRequestLabelChangeInput = Schema.Struct({
	...PullRequestRef.fields,
	labels: Schema.Array(TrimmedNonEmptyString).check(
		Schema.isMinLength(1),
		Schema.isMaxLength(25),
	),
	applied: Schema.Boolean,
});
export type PullRequestLabelChangeInput =
	typeof PullRequestLabelChangeInput.Type;
...
export type PullRequestUnavailableReason =
	typeof PullRequestUnavailableReason.Type;
...
export function resolvePullRequestAuthorFilter(
	...
	return viewer === null || viewer === undefined || viewer.trim().length === 0
		? trimmed
		: viewer;
}
...
export class PullRequestUnavailableError extends Schema.TaggedError<PullRequestUnavailableError>()(
	...
	[HttpServerRespondable.symbol]() {
		return HttpServerResponse.schemaJson(PullRequestUnavailableError)(this, {
			status: 503,
		});
	}
	...
	override get message(): string {
		const requirement =
			this.provider === undefined
				? undefined
				: PROVIDER_REQUIREMENT[this.provider];
		switch (this.reason) {
			case "cli-missing":
				return (
					requirement?.missing ??
...
export class PullRequestOperationError extends Schema.TaggedError<PullRequestOperationError>()(
	...
	[HttpServerRespondable.symbol]() {
		return HttpServerResponse.schemaJson(PullRequestOperationError)(this, {
			status: 502,
		});
	}
