...
export type ResourceTelemetryIoSemantics =
	typeof ResourceTelemetryIoSemantics.Type;
...
export type ResourceTelemetryProcessCategory =
	typeof ResourceTelemetryProcessCategory.Type;
...
export type ResourceTelemetrySourceStatus =
	typeof ResourceTelemetrySourceStatus.Type;

export const ResourceTelemetryProcessIdentity = Schema.Struct({
	pid: PositiveInt,
	startTimeMs: NonNegativeInt,
});
export type ResourceTelemetryProcessIdentity =
	typeof ResourceTelemetryProcessIdentity.Type;

export const ResourceMonitorExternalProcess = Schema.Struct({
	pid: PositiveInt,
	startTimeMs: Schema.optionalKey(NonNegativeInt),
});
export type ResourceMonitorExternalProcess =
	typeof ResourceMonitorExternalProcess.Type;
...
export type ResourceMonitorCapabilities =
	typeof ResourceMonitorCapabilities.Type;
...
export type ResourceMonitorProcessSample =
	typeof ResourceMonitorProcessSample.Type;
...
export type ResourceMonitorConfigureCommand =
	typeof ResourceMonitorConfigureCommand.Type;
...
export type ResourceMonitorSampleNowCommand =
	typeof ResourceMonitorSampleNowCommand.Type;
...
export type ResourceMonitorProcessTableCommand =
	typeof ResourceMonitorProcessTableCommand.Type;
...
export type ResourceMonitorSetStreamingCommand =
	typeof ResourceMonitorSetStreamingCommand.Type;
...
export type ResourceMonitorReadHistoryCommand =
	typeof ResourceMonitorReadHistoryCommand.Type;

export const ResourceMonitorShutdownCommand = Schema.Struct({
	version: Schema.Literal(RESOURCE_MONITOR_PROTOCOL_VERSION),
	type: Schema.Literal("shutdown"),
});
export type ResourceMonitorShutdownCommand =
	typeof ResourceMonitorShutdownCommand.Type;
...
export const ResourceMonitorSnapshotEvent = Schema.Struct({
	...
	externalProcesses: Schema.optionalKey(
		Schema.Array(ResourceMonitorExternalProcess),
	),
	processes: Schema.Array(ResourceMonitorProcessSample),
});
export type ResourceMonitorSnapshotEvent =
	typeof ResourceMonitorSnapshotEvent.Type;
...
export type ResourceMonitorProcessTableEntry =
	typeof ResourceMonitorProcessTableEntry.Type;
...
export type ResourceMonitorProcessTableEvent =
	typeof ResourceMonitorProcessTableEvent.Type;
...
export type ResourceMonitorHistoryChunkEvent =
	typeof ResourceMonitorHistoryChunkEvent.Type;
...
export type DesktopElectronProcessMetric =
	typeof DesktopElectronProcessMetric.Type;
...
export type DesktopHostTelemetrySnapshot =
	typeof DesktopHostTelemetrySnapshot.Type;
...
export type DesktopHostTelemetryMessage =
	typeof DesktopHostTelemetryMessage.Type;
...
export type DesktopTelemetrySetDiagnosticsDemand =
	typeof DesktopTelemetrySetDiagnosticsDemand.Type;
...
export type DesktopTelemetryRequestDesktopUpdate =
	typeof DesktopTelemetryRequestDesktopUpdate.Type;
...
export type DesktopTelemetryCommitDesktopUpdate =
	typeof DesktopTelemetryCommitDesktopUpdate.Type;
...
export type DesktopTelemetryCancelDesktopUpdate =
	typeof DesktopTelemetryCancelDesktopUpdate.Type;
...
export type DesktopTelemetryControlMessage =
	typeof DesktopTelemetryControlMessage.Type;
...
export type ResourceTelemetrySourceHealth =
	typeof ResourceTelemetrySourceHealth.Type;
...
export type ResourceAttributionSnapshot =
	typeof ResourceAttributionSnapshot.Type;
...
export type ResourceTelemetryHistoryInput =
	typeof ResourceTelemetryHistoryInput.Type;
...
export type ResourceTelemetryHistoryBucket =
	typeof ResourceTelemetryHistoryBucket.Type;
...
export type ResourceTelemetryProcessSummary =
	typeof ResourceTelemetryProcessSummary.Type;
...
export type ResourceTelemetryRetryResult =
	typeof ResourceTelemetryRetryResult.Type;
