...
const WsServerUpsertKeybindingRpc = Rpc.make(
...
const WsServerRemoveKeybindingRpc = Rpc.make(
...
const WsServerRefreshProvidersRpc = Rpc.make(
...
const WsProviderConsumeResetCreditRpc = Rpc.make(
...
const WsProviderInstallSubscribeRpc = Rpc.make(
...
const WsServerUpdateServerWithProgressRpc = Rpc.make(
...
const WsServerCommitDesktopUpdateRpc = Rpc.make(
...
const WsServerDiscoverSourceControlRpc = Rpc.make(
...
const WsServerGetTraceDiagnosticsRpc = Rpc.make(
...
const WsServerGetProcessDiagnosticsRpc = Rpc.make(
...
const WsServerGetHostResourcesRpc = Rpc.make(
...
const WsServerGetProcessResourceHistoryRpc = Rpc.make(
...
const WsServerRetryResourceTelemetryRpc = Rpc.make(
 ...
 */
const WsServerRefreshUsageRatesRpc = Rpc.make(
...
const WsCloudGetRelayClientStatusRpc = Rpc.make(
...
const WsCloudInstallRelayClientRpc = Rpc.make(
...
const WsServerReportClientActivityRpc = Rpc.make(
...
const WsServerReportHostPowerStateRpc = Rpc.make(
...
const WsServerGetBackgroundPolicyRpc = Rpc.make(
...
const WsPullRequestsThreadCommentsRpc = Rpc.make(
...
const WsPullRequestsDiffFileContentsRpc = Rpc.make(
...
const WsPullRequestsUpdateCommentRpc = Rpc.make(
...
const WsPullRequestsSubmitReviewRpc = Rpc.make(
...
const WsPullRequestsReplyToThreadRpc = Rpc.make(
...
const WsPullRequestsSetThreadResolutionRpc = Rpc.make(
...
const WsPullRequestsSetReactionRpc = Rpc.make(
...
const WsPullRequestsInvalidateRpc = Rpc.make(
...
const WsPullRequestsSubscribeRefreshesRpc = Rpc.make(
 ...
 */
const WsPullRequestsReviewerCandidatesRpc = Rpc.make(
...
const WsPullRequestsRequestReviewersRpc = Rpc.make(
...
const WsPullRequestsLabelCandidatesRpc = Rpc.make(
...
const WsSourceControlLookupRepositoryRpc = Rpc.make(
...
const WsSourceControlCloneRepositoryRpc = Rpc.make(
...
const WsSourceControlPublishRepositoryRpc = Rpc.make(
...
const WsProjectsSearchContentsRpc = Rpc.make(
...
const WsAttachmentsCreateUploadUrlRpc = Rpc.make(
...
const WsProviderUploadFeedbackRpc = Rpc.make(
...
const WsGitPreparePullRequestThreadRpc = Rpc.make(
...
const WsReviewGetDiffFileContentsRpc = Rpc.make(
...
const WsPreviewAutomationConnectRpc = Rpc.make(
...
const WsPreviewAutomationRespondRpc = Rpc.make(
...
const WsPreviewAutomationFocusHostRpc = Rpc.make(
...
const WsSubscribePreviewEventsRpc = Rpc.make(
...
const WsSubscribeDiscoveredLocalServersRpc = Rpc.make(
...
const WsOrchestrationGetWorkflowScriptRpc = Rpc.make(
...
const WsOrchestrationGetTurnDiffRpc = Rpc.make(
...
const WsOrchestrationSearchThreadsRpc = Rpc.make(
...
const WsOrchestrationSubscribeShellRpc = Rpc.make(
...
const WsOrchestrationSubscribeThreadRpc = Rpc.make(
...
const WsSubscribeTerminalEventsRpc = Rpc.make(
...
const WsSubscribeTerminalMetadataRpc = Rpc.make(
...
const WsSubscribeServerLifecycleRpc = Rpc.make(
...
const WsSubscribeBackgroundPolicyRpc = Rpc.make(
...
const WsSubscribeResourceTelemetryRpc = Rpc.make(
