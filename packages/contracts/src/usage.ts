...
export const UsageDay = TrimmedNonEmptyString.check(
	Schema.isPattern(USAGE_DAY_PATTERN),
).pipe(Schema.brand("UsageDay"));
...
export const UsagePricingStatus = Schema.Literals([
	"fresh",
	"cached",
	"unavailable",
]);
