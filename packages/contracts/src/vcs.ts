...
export type VcsListWorkspaceFilesResult =
	typeof VcsListWorkspaceFilesResult.Type;
...
export class VcsProcessTimeoutError extends Schema.TaggedErrorClass<VcsProcessTimeoutError>()(
	...
	static fromProcessTimeoutError(
		context: VcsProcessErrorContext,
		error: VcsProcessTimeoutFailure,
	) {
