...
export const CLIENT_REQUEST_PARAMS = {
	...
	"account/sendAddCreditsNudgeEmail":
		CodexSchema.V2SendAddCreditsNudgeEmailParams,
...
export const SERVER_REQUEST_PARAMS = {
	"item/commandExecution/requestApproval":
		CodexSchema.CommandExecutionRequestApprovalParams,
	"item/fileChange/requestApproval":
		CodexSchema.FileChangeRequestApprovalParams,
	"item/tool/requestUserInput": CodexSchema.ToolRequestUserInputParams,
	"mcpServer/elicitation/request":
		CodexSchema.McpServerElicitationRequestParams,
	"item/permissions/requestApproval":
		CodexSchema.PermissionsRequestApprovalParams,
	"item/tool/call": CodexSchema.DynamicToolCallParams,
	"account/chatgptAuthTokens/refresh":
		CodexSchema.ChatgptAuthTokensRefreshParams,
...
export const SERVER_REQUEST_RESPONSES = {
	"item/commandExecution/requestApproval":
		CodexSchema.CommandExecutionRequestApprovalResponse,
	"item/fileChange/requestApproval":
		CodexSchema.FileChangeRequestApprovalResponse,
	"item/tool/requestUserInput": CodexSchema.ToolRequestUserInputResponse,
	"mcpServer/elicitation/request":
		CodexSchema.McpServerElicitationRequestResponse,
	"item/permissions/requestApproval":
...
export const SERVER_NOTIFICATION_PARAMS = {
	...
	"fuzzyFileSearch/sessionUpdated":
		CodexSchema.FuzzyFileSearchSessionUpdatedNotification,
	"fuzzyFileSearch/sessionCompleted":
		CodexSchema.FuzzyFileSearchSessionCompletedNotification,
