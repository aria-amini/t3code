...
const ClerkPublishableKeyPrefix = Schema.Literals([
	"pk_test",
	"pk_live",
	"unknown",
]);
...
export function clerkFrontendApiUrlFromPublishableKey(
	publishableKey: string,
): string {
	return parseClerkFrontendApi(publishableKey).url;
}

export function clerkFrontendApiHostnameFromPublishableKey(
	publishableKey: string,
): string {
