...
export const STANDARD_THEME_PREVIEW_COLORS: Readonly<
	Record<ThemeAppearance, ThemePreviewColors>
> = {
	light: {
		canvas: "#fcfcfc",
		accent: "#f4f4f5",
...
export const THEME_PREVIEW_RENDER_SPECS: Readonly<
	Record<ThemeAppearance, ThemePreviewRenderSpec>
> = {
	light: {
		baseTarget: "#ffffff",
		baseWeight: 0.8,
...
export function mixThemePreviewBase(
