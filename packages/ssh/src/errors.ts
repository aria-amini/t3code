...
export class SshHostDiscoveryError extends Data.TaggedError(
...
export class SshInvalidTargetError extends Data.TaggedError(
...
export class SshPasswordPromptError extends Data.TaggedError(
